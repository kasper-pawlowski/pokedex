        ...
        fetch(request, {
            ...
            .then((data) => {
                this.setState({
                    ...
                    description: pickRandom(data.flavor_text_entries.filter((e) => e.language.name === 'en').map((e) => e.flavor_text)),
    ...
    render() {
        ...
        return (
            <div className="pokedex">
                <LeftPanel pData={pData} sData={sData} no={this.state.pokemonIndex} description={this.state.description} />
                <Divider />
                <RightPanel
                    pData={pData}
                    sData={sData}
    ...
    render() {
        ...
        return (
            <div>
                ...
                <SpriteControls funcs={funcs} gender={this.state.female} shiny={this.state.shiny} front={this.state.front} />
            </div>
        );
    }
}
...
function SpriteControls(props) {
    return (
        <div className="sprite-controls">
            <div className={'sprite-control sprite-controls-gender ' + (props.gender ? 'sprite-control-selected' : '')} onClick={props.funcs.gender}>
                <i className="fas fa-venus" />
            </div>
            <div className={'sprite-control sprite-controls-shiny ' + (props.shiny ? 'sprite-control-selected' : '')} onClick={props.funcs.shiny}>
                <span>shiny</span>
            </div>
            <div className={'sprite-control sprite-controls-rotate ' + (!props.front ? 'sprite-control-selected' : '')} onClick={props.funcs.front}>
...
class NumInput extends React.Component {
    ...
    render() {
        return (
            <div>
                <input type="number" className="screen num-input" placeholder={this.props.no} onChange={this.handleChange} />
